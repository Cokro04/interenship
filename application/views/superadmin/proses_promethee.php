        ...
        <div class="col-lg-12">
            <div class="panel-group">
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <h4 class="panel-title">
                            <a data-toggle="collapse" href="#collapse2">Data Perbandingan Nilai Kali Bobo</a>
                        </h4>
                    </div>
                    <div id="collapse2" class="panel-collapse collapse">
                        <div class="panel-body">
                            <h3>Tabel Data Perbandingan Nilai Kali Bobo</h3>
                            <div class="panel panel-info">
                                <!-- /.panel-heading -->
                                <div class="panel-body table-responsive">
                                    <table class="table">
            ...
            <div class="panel panel-info">
                ...
                <div class="panel-body table-responsive">
                    <table class="table">
                        <thead class="thead-dark">
                            <tr>
                                <th scope="col">Urutan Alternatif</th>
                            ...
                            <tbody>
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <?= date('Y-m-d'); ?>
                                        <td><input type="text" name="id_workcenter[]" value="<?= $id_workcenter ?>" required>
                                            <input type="text" name="date[]" value="<?= date('Y-m-d'); ?>" required></td>
                                        <!-- <td>100</td> -->
                                    </tr>
                                <?php
                                                                                                    }
